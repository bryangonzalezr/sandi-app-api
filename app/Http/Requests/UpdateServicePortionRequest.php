...
class UpdateServicePortionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'desayuno.legumbres' => ['required', 'numeric'],
            ...
            'colacion.legumbres' => ['required', 'numeric'],
            ...
            'almuerzo.legumbres' => ['required', 'numeric'],
            ...
            'once.legumbres' => ['required', 'numeric'],
            ...
            'cena.legumbres' => ['required', 'numeric'],
